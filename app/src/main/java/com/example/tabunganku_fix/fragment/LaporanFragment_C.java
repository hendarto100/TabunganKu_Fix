...
public class LaporanFragment_C extends Fragment {

    private LaporanViewModel_C laporanViewModelC;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        laporanViewModelC =
                ViewModelProviders.of(this).get(LaporanViewModel_C.class);
        final View v = inflater.inflate(R.layout.fragment_laporan_tabungan_c, container, false);
        String token = user.getToken();
        bar = v.findViewById(R.id.bar_c);
        hide = v.findViewById(R.id.bar_laporan_c);
                ...
                if (response.isSuccessful()) {
                    for (Transaksi var : responseTransaksi.getTransaksi())
                        if(var.getJenis_tabungan().equals("Tabungan Wisata")){ {
                            ...
                            recyclerView = v.findViewById(R.id.recyclerview_c);
