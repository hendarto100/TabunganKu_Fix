...
public class HomeFragment_C extends Fragment implements View.OnClickListener{

    private HomeViewModel_C homeViewModelC;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        homeViewModelC =
                ViewModelProviders.of(this).get(HomeViewModel_C.class);
        final View v = inflater.inflate(R.layout.fragment_home_tabungan_c, container, false);
        recyclerView1 = v.findViewById(R.id.recyclerview_card_home_c);
        nama_pengguna = v.findViewById(R.id.text_home);
        bar = v.findViewById(R.id.bar_c_home);
        hide = v.findViewById(R.id.scroll_c);
        jenis_tabungan = v.findViewById(R.id.nama_tabungan_home_c);
            ...
            public void onResponse(Call<TransaksiResponse> call, Response<TransaksiResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    for (Transaksi var : transaksiResponse.getTransaksi())
                        if(var.getJenis_tabungan().equals("Tabungan Wisata")){
                            ...
                            recyclerView = v.findViewById(R.id.recyclerview_home_c);
    ...
    public void onClick(View view) {
       /* if (view.getId()== R.id.cards_home_c){
            Intent intent = new Intent(getActivity(), Detail_tabunganC.class);
            ...
            public void onResponse(Call<SaldoResponse> call, Response<SaldoResponse> response) {
                ...
                if(response.isSuccessful()){
                    for (Saldo var:saldoRersponse.getData_saldo()) {
                        ...
                        recyclerView1.findViewById(R.id.recyclerview_card_home_c);
