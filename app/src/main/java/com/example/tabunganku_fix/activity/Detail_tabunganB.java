...
public class Detail_tabunganB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_tabungan_b);
        Button button = findViewById(R.id.kembali_home_b);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Detail_tabunganB.this, MainActivity_TabunganB.class);
            ...
            public void onResponse(Call<JenisTabunganResponse> call, Response<JenisTabunganResponse> response) {
                ...
                if(response.isSuccessful()){
                    if(jenisTabunganResponse.getStatus().equals("success")) {
                        ...
                        recyclerView =  findViewById(R.id.recyclerview_detail_b);
                        recyclerView.setHasFixedSize(true);

                        layoutManager = new LinearLayoutManager(Detail_tabunganB.this);
